...
tcov<-function(ats1,ats2,sim,family="gaussian",method="Gest"){
  ...
  ##else
  ##   if (Nstage==3 && Base==1) {
  ##     P0<-mean(Smat$P1[which(Smat$O1==0)])
  ##     if (is.nan(P0)) {P0<-0}
  ##     P1<-mean(Smat$P1[which(Smat$O1==1)])
  ##     if (is.nan(P1)) {P1<-0}
##
  ##    pi0J<-mean(Smat$PI1[which(Smat$O1==0 & Smat$A1==ATS1[1])])
  ##    if (is.nan(pi0J)) {pi0J<-1}
  ...
  ##    if (is.nan(pi1J)) {pi1J<-1}
##
  ##P00J<-mean(Smat$P2[which(Smat$O1==0 &
  ##                          Smat$A1==ATS1[1] & Smat$O2==0)])
  ##if (is.nan(P00J)) {P00J<-0}
  ##P01J<-mean(Smat$P2[which(Smat$O1==0 &
  ##                          Smat$A1==ATS1[1] & Smat$O2==1)])
  ##if (is.nan(P01J)) {P01J<-0}
  ##P10J<-mean(Smat$P2[which(Smat$O1==1 &
  ##                          Smat$A1==ATS1[2] & Smat$O2==0)])
  ##if (is.nan(P10J)) {P10J<-0}
  ##P11J<-mean(Smat$P2[which(Smat$O1==1 &
  ##                          Smat$A1==ATS1[2] & Smat$O2==1)])
  ##if (is.nan(P11J)) {P11J<-0}
  ##P00K<-mean(Smat$P2[which(Smat$O1==0 &
  ##                          Smat$A1==ATS2[1] & Smat$O2==0)])
  ##if (is.nan(P00K)) {P00K<-0}
  ##P01K<-mean(Smat$P2[which(Smat$O1==0 &
  ##                          Smat$A1==ATS2[1] & Smat$O2==1)])
  ##if (is.nan(P01K)) {P01K<-0}
  ##P10K<-mean(Smat$P2[which(Smat$O1==1 &
  ##                          Smat$A1==ATS2[2] & Smat$O2==0)])
  ##if (is.nan(P10K)) {P10K<-0}
  ##P11K<-mean(Smat$P2[which(Smat$O1==1 &
  ##                          Smat$A1==ATS2[2] & Smat$O2==1)])
  ##if (is.nan(P11K)) {P11K<-0}
  ##pi00J<-mean(Smat$PI2[which(Smat$O1==0 &
  ##                            Smat$A1==ATS1[1] &
  ##                            Smat$O2==0 &
  ##                            Smat$A2==ATS1[3])])
  ##if (is.nan(pi00J)) {pi00J<-1}
  ##pi01J<-mean(Smat$PI2[which(Smat$O1==0 &
  ##                            Smat$A1==ATS1[1] &
  ##                            Smat$O2==1 &
  ##                            Smat$A2==ATS1[4])])
  ##if (is.nan(pi01J)) {pi01J<-1}
  ##pi10J<-mean(Smat$PI2[which(Smat$O1==1 &
  ##                            Smat$A1==ATS1[2] &
  ##                            Smat$O2==0 &
  ##                            Smat$A2==ATS1[5])])
  ##if (is.nan(pi10J)) {pi10J<-1}
  ##pi11J<-mean(Smat$PI2[which(Smat$O1==1 &
  ##                            Smat$A1==ATS1[2] &
  ##                            Smat$O2==1 &
  ##                            Smat$A2==ATS1[6])])
  ##if (is.nan(pi11J)) {pi11J<-1}
  ##P000J<-mean(Smat$P3[which(Smat$O1==0 &
  ##                           Smat$A1==ATS1[1] &
  ##                           Smat$O2==0 &
  ##                           Smat$A2==ATS1[3] &
  ##                           Smat$O3==0)])
  ##if (is.nan(P000J)) {P000J<-0}
  ##P001J<-mean(Smat$P3[which(Smat$O1==0 &
  ##                           Smat$A1==ATS1[1] &
  ##                           Smat$O2==0 &
  ##                           Smat$A2==ATS1[3] &
  ##                           Smat$O3==1)])
  ##if (is.nan(P001J)) {P001J<-0}
  ##P010J<-mean(Smat$P3[which(Smat$O1==0 &
  ##                           Smat$A1==ATS1[1] &
  ##                           Smat$O2==1 &
  ##                           Smat$A2==ATS1[4] &
  ##                           Smat$O3==0)])
  ##if (is.nan(P010J)) {P010J<-0}
  ##P011J<-mean(Smat$P3[which(Smat$O1==0 &
  ##                           Smat$A1==ATS1[1] &
  ##                           Smat$O2==1 &
  ##                           Smat$A2==ATS1[4] &
  ##                           Smat$O3==1)])
  ##if (is.nan(P011J)) {P011J<-0}
  ##P100J<-mean(Smat$P3[which(Smat$O1==1 &
  ##                           Smat$A1==ATS1[2] & Smat$O2==0 &
  ##                           Smat$A2==ATS1[5] & Smat$O3==0)])
  ##if (is.nan(P100J)) {P100J<-0}
  ##P101J<-mean(Smat$P3[which(Smat$O1==1 &
  ##                           Smat$A1==ATS1[2] & Smat$O2==0 &
  ##                           Smat$A2==ATS1[5] & Smat$O3==1)])
  ##if (is.nan(P101J)) {P101J<-0}
  ##P110J<-mean(Smat$P3[which(Smat$O1==1 &
  ##                           Smat$A1==ATS1[2] & Smat$O2==1 &
  ##                           Smat$A2==ATS1[6] & Smat$O3==0)])
  ##if (is.nan(P110J)) {P110J<-0}
  ##P111J<-mean(Smat$P3[which(Smat$O1==1 &
  ##                           Smat$A1==ATS1[2] & Smat$O2==1 &
  ##                           Smat$A2==ATS1[6] & Smat$O3==1)])
  ##if (is.nan(P111J)) {P111J<-0}
  ##P000K<-mean(Smat$P3[which(Smat$O1==0 &
  ##                           Smat$A1==ATS2[1] & Smat$O2==0 &
  ##                           Smat$A2==ATS2[3] & Smat$O3==0)])
  ##if (is.nan(P000K)) {P000K<-0}
  ##P001K<-mean(Smat$P3[which(Smat$O1==0 &
  ##                           Smat$A1==ATS2[1] & Smat$O2==0 &
  ##                           Smat$A2==ATS2[3] & Smat$O3==1)])
  ##if (is.nan(P001K)) {P001K<-0}
  ##P010K<-mean(Smat$P3[which(Smat$O1==0 &
  ##                           Smat$A1==ATS2[1] & Smat$O2==1 &
  ##                           Smat$A2==ATS2[4] & Smat$O3==0)])
  ##if (is.nan(P010K)) {P010K<-0}
  ##P011K<-mean(Smat$P3[which(Smat$O1==0 &
  ##                           Smat$A1==ATS2[1] & Smat$O2==1 &
  ##                           Smat$A2==ATS2[4] & Smat$O3==1)])
  ##if (is.nan(P011K)) {P011K<-0}
  ##P100K<-mean(Smat$P3[which(Smat$O1==1 &
  ##                           Smat$A1==ATS2[2] & Smat$O2==0 &
  ##                           Smat$A2==ATS2[5] & Smat$O3==0)])
  ##if (is.nan(P100K)) {P100K<-0}
  ##P101K<-mean(Smat$P3[which(Smat$O1==1 &
  ##                           Smat$A1==ATS2[2] & Smat$O2==0 &
  ##                           Smat$A2==ATS2[5] & Smat$O3==1)])
  ##if (is.nan(P101K)) {P101K<-0}
  ##P110K<-mean(Smat$P3[which(Smat$O1==1 &
  ##                           Smat$A1==ATS2[2] & Smat$O2==1 &
  ##                           Smat$A2==ATS2[6] & Smat$O3==0)])
  ##if (is.nan(P110K)) {P110K<-0}
  ##P111K<-mean(Smat$P3[which(Smat$O1==1 &
  ##                           Smat$A1==ATS2[2] & Smat$O2==1 &
  ##                           Smat$A2==ATS2[6] & Smat$O3==1)])
  ##if (is.nan(P111K)) {P111K<-0}
  ##pi000J<-mean(Smat$PI3[which(Smat$O1==0 &
  ##                             Smat$A1==ATS1[1] & Smat$O2==0 &
  ##                             Smat$A2==ATS1[3] & Smat$O3==0 &
  ##                             Smat$A3==ATS1[7])])
  ##if (is.nan(P000J)) {P000J<-0}
  ##pi001J<-mean(Smat$PI3[which(Smat$O1==0 &
  ##                             Smat$A1==ATS1[1] & Smat$O2==0 &
  ##                             Smat$A2==ATS1[3] & Smat$O3==1 &
  ##                             Smat$A3==ATS1[8])])
  ##if (is.nan(P001J)) {P001J<-0}
  ##pi010J<-mean(Smat$PI3[which(Smat$O1==0 &
  ##                             Smat$A1==ATS1[1] & Smat$O2==1 &
  ##                             Smat$A2==ATS1[4] & Smat$O3==0 &
  ##                             Smat$A3==ATS1[9])])
  ##if (is.nan(P010J)) {P010J<-0}
  ##pi011J<-mean(Smat$PI3[which(Smat$O1==0 &
  ##                             Smat$A1==ATS1[1] & Smat$O2==1 &
  ##                             Smat$A2==ATS1[4] & Smat$O3==1 &
  ##                             Smat$A3==ATS1[10])])
  ##if (is.nan(P011J)) {P011J<-0}
  ##pi100J<-mean(Smat$PI3[which(Smat$O1==1 &
  ##                             Smat$A1==ATS1[2] & Smat$O2==0 &
  ##                             Smat$A2==ATS1[5] & Smat$O3==0 &
  ##                             Smat$A3==ATS1[11])])
  ##if (is.nan(P100J)) {P100J<-0}
  ##pi101J<-mean(Smat$PI3[which(Smat$O1==1 &
  ##                             Smat$A1==ATS1[2] & Smat$O2==0 &
  ##                             Smat$A2==ATS1[5] & Smat$O3==1 &
  ##                             Smat$A3==ATS1[12])])
  ##if (is.nan(P101J)) {P101J<-0}
  ##pi110J<-mean(Smat$PI3[which(Smat$O1==1 &
  ##                             Smat$A1==ATS1[2] & Smat$O2==1 &
  ##                             Smat$A2==ATS1[6] & Smat$O3==0 &
  ##                             Smat$A3==ATS1[13])])
  ##if (is.nan(P110J)) {P110J<-0}
  ##pi111J<-mean(Smat$PI3[which(Smat$O1==1 &
  ##                             Smat$A1==ATS1[2] & Smat$O2==1 &
  ##                             Smat$A2==ATS1[6] & Smat$O3==1 &
  ##                             Smat$A3==ATS1[14])])
  ##if (is.nan(P111J)) {P111J<-0}
  ##u000J<-Smat$MEAN[which(Smat$O1==0 &
  ##                        Smat$A1==ATS1[1] & Smat$O2==0 &
  ##                        Smat$A2==ATS1[3] & Smat$O3==0 &
  ##                        Smat$A3==ATS1[7])]
  ##if (is.na(u000J)) {u000J<-0}
  ##u001J<-Smat$MEAN[which(Smat$O1==0 &
  ##                        Smat$A1==ATS1[1] & Smat$O2==0 &
  ##                        Smat$A2==ATS1[3] & Smat$O3==1 &
  ##                        Smat$A3==ATS1[8])]
  ##if (is.na(u001J)) {u001J<-0}
  ##u010J<-Smat$MEAN[which(Smat$O1==0 &
  ##                        Smat$A1==ATS1[1] & Smat$O2==1 &
  ##                        Smat$A2==ATS1[4] & Smat$O3==0 &
  ##                        Smat$A3==ATS1[9])]
  ##if (is.na(u010J)) {u010J<-0}
  ##u011J<-Smat$MEAN[which(Smat$O1==0 &
  ##                        Smat$A1==ATS1[1] & Smat$O2==1 &
  ##                        Smat$A2==ATS1[4] & Smat$O3==1 &
  ##                        Smat$A3==ATS1[10])]
  ##if (is.na(u011J)) {u011J<-0}
  ##u100J<-Smat$MEAN[which(Smat$O1==1 &
  ##                        Smat$A1==ATS1[2] & Smat$O2==0 &
  ##                        Smat$A2==ATS1[5] & Smat$O3==0 &
  ##                        Smat$A3==ATS1[11])]
  ##if (is.na(u100J)) {u100J<-0}
  ##u101J<-Smat$MEAN[which(Smat$O1==1 &
  ##                        Smat$A1==ATS1[2] & Smat$O2==0 &
  ##                        Smat$A2==ATS1[5] & Smat$O3==1 &
  ##                        Smat$A3==ATS1[12])]
  ##if (is.na(u101J)) {u101J<-0}
  ##u110J<-Smat$MEAN[which(Smat$O1==1 &
  ##                        Smat$A1==ATS1[2] & Smat$O2==1 &
  ##                        Smat$A2==ATS1[6] & Smat$O3==0 &
  ##                        Smat$A3==ATS1[13])]
  ##if (is.na(u110J)) {u110J<-0}
  ##u111J<-Smat$MEAN[which(Smat$O1==1 &
  ##                        Smat$A1==ATS1[2] & Smat$O2==1 &
  ##                        Smat$A2==ATS1[6] & Smat$O3==1 &
  ##                        Smat$A3==ATS1[14])]
  ##if (is.na(u111J)) {u111J<-0}
  ##u000K<-Smat$MEAN[which(Smat$O1==0 &
  ##                        Smat$A1==ATS2[1] & Smat$O2==0 &
  ##                        Smat$A2==ATS2[3] & Smat$O3==0 &
  ##                        Smat$A3==ATS2[7])]
  ##if (is.na(u000K)) {u000K<-0}
  ##u001K<-Smat$MEAN[which(Smat$O1==0 &
  ##                        Smat$A1==ATS2[1] & Smat$O2==0 &
  ##                        Smat$A2==ATS2[3] & Smat$O3==1 &
  ##                        Smat$A3==ATS2[8])]
  ##if (is.na(u001K)) {u001K<-0}
  ##u010K<-Smat$MEAN[which(Smat$O1==0 &
  ##                        Smat$A1==ATS2[1] & Smat$O2==1 &
  ##                        Smat$A2==ATS2[4] & Smat$O3==0 &
  ##                        Smat$A3==ATS2[9])]
  ##if (is.na(u010K)) {u010K<-0}
  ##u011K<-Smat$MEAN[which(Smat$O1==0 &
  ##                        Smat$A1==ATS2[1] & Smat$O2==1 &
  ##                        Smat$A2==ATS2[4] & Smat$O3==1 &
  ##                        Smat$A3==ATS2[10])]
  ##if (is.na(u011K)) {u011K<-0}
  ##u100K<-Smat$MEAN[which(Smat$O1==1 &
  ##                        Smat$A1==ATS2[2] & Smat$O2==0 &
  ##                        Smat$A2==ATS2[5] & Smat$O3==0 &
  ##                        Smat$A3==ATS2[11])]
  ##if (is.na(u100K)) {u100K<-0}
  ##u101K<-Smat$MEAN[which(Smat$O1==1 &
  ##                        Smat$A1==ATS2[2] & Smat$O2==0 &
  ##                        Smat$A2==ATS2[5] & Smat$O3==1 &
  ##                        Smat$A3==ATS2[12])]
  ##if (is.na(u101K)) {u101K<-0}
  ##u110K<-Smat$MEAN[which(Smat$O1==1 &
  ##                        Smat$A1==ATS2[2] & Smat$O2==1 &
  ##                        Smat$A2==ATS2[6] & Smat$O3==0 &
  ##                        Smat$A3==ATS2[13])]
  ##if (is.na(u110K)) {u110K<-0}
  ##u111K<-Smat$MEAN[which(Smat$O1==1 &
  ##                        Smat$A1==ATS2[2] & Smat$O2==1 &
  ##                        Smat$A2==ATS2[6] & Smat$O3==1 &
  ##                        Smat$A3==ATS2[14])]
  ##if (is.na(u111K)) {u111K<-0}
  ##if (FA=="gaussian"){
  ##  v000J<-Smat$SD[which(Smat$O1==0 &
  ##                        Smat$A1==ATS1[1] & Smat$O2==0 &
  ##                        Smat$A2==ATS1[3] & Smat$O3==0 &
  ##                        Smat$A3==ATS1[7])]^2
  ##  v001J<-Smat$SD[which(Smat$O1==0 &
  ##                        Smat$A1==ATS1[1] & Smat$O2==0 &
  ##                        Smat$A2==ATS1[3] & Smat$O3==1 &
  ##                        Smat$A3==ATS1[8])]^2
  ##  v010J<-Smat$SD[which(Smat$O1==0 &
  ##                        Smat$A1==ATS1[1] & Smat$O2==1 &
  ##                        Smat$A2==ATS1[4] & Smat$O3==0 &
  ##                        Smat$A3==ATS1[9])]^2
  ##  v011J<-Smat$SD[which(Smat$O1==0 &
  ##                        Smat$A1==ATS1[1] & Smat$O2==1 &
  ##                        Smat$A2==ATS1[4] & Smat$O3==1 &
  ##                        Smat$A3==ATS1[10])]^2
  ##  v100J<-Smat$SD[which(Smat$O1==1 &
  ##                        Smat$A1==ATS1[2] & Smat$O2==0 &
  ##                        Smat$A2==ATS1[5] & Smat$O3==0 &
  ##                        Smat$A3==ATS1[11])]^2
  ##  v101J<-Smat$SD[which(Smat$O1==1 &
  ##                        Smat$A1==ATS1[2] & Smat$O2==0 &
  ##                        Smat$A2==ATS1[5] & Smat$O3==1 &
  ##                        Smat$A3==ATS1[12])]^2
  ##  v110J<-Smat$SD[which(Smat$O1==1 &
  ##                        Smat$A1==ATS1[2] & Smat$O2==1 &
  ##                        Smat$A2==ATS1[6] & Smat$O3==0 &
  ##                        Smat$A3==ATS1[13])]^2
  ##  v111J<-Smat$SD[which(Smat$O1==1 &
  ##                        Smat$A1==ATS1[2] & Smat$O2==1 &
  ##                        Smat$A2==ATS1[6] & Smat$O3==1 &
  ##                        Smat$A3==ATS1[14])]^2} else
  ...
  ##                       bv111J<-u111J*(1-u111J)}else
  ##                         stop("invalid enter for argument 'family'")
  ##  if (length(v000J)==0) {v000J<-0}
  ##  if (length(v001J)==0) {v001J<-0}
  ##  if (length(v010J)==0) {v010J<-0}
  ##  if (length(v011J)==0) {v011J<-0}
  ##  if (length(v100J)==0) {v100J<-0}
  ##  if (length(v101J)==0) {v101J<-0}
  ##  if (length(v110J)==0) {v110J<-0}
  ##  if (length(v111J)==0) {v111J<-0}
##
  ##  A000.000<-( P0*(1-P0)*P00J*P00K*P000J*P000K+
  ##               I[1]*P0*P0*P00J*(1-P00J)*P000J*P000K/(P0*pi0J)+
  ##               I[1]*I[3]*P0*P0*P00J*P00K*P000J*
  ##               (1-P000J)/(P0*pi0J*P00J*pi00J))*u000J*u000K
  ##  A000.001<-( P0*(1-P0)*P00J*P00K*P000J*P001K+
  ##               I[1]*P0*P0*P00J*(1-P00J)*P000J*
  ##               P001K/(P0*pi0J)-
  ##               I[1]*I[3]*P0*P0*P00J*P00K*P000J*
  ##               (1-P000J)/(P0*pi0J*P00J*pi00J))*u000J*u001K
  ##  A000.010<-( P0*(1-P0)*P00J*P10K*P000J*P010K-
  ##               I[1]*P0*P0*P00J*(1-P00J)*P000J*
  ##               P010K/(P0*pi0J))*u000J*u010K
  ##  A000.011<-( P0*(1-P0)*P00J*P01K*P000J*P011K-
  ##               I[1]*P0*P0*P00J*(1-P00J)*P000J*
  ##               P011K/(P0*pi0J))*u000J*u011K
  ...
  ##  A001.000<-( P0*(1-P0)*P00J*P00K*P001J*P000K+
  ##               I[1]*P0*P0*P00J*(1-P00J)*P001J*
  ##               P000K/(P0*pi0J)-I[1]*I[3]*P0*P0*P00J*
  ##               P00K*P001J*(1-P001J)/(P0*pi0J*P00J*pi00J))*u001J*u000K
  ##  A001.001<-( P0*(1-P0)*P00J*P00K*P001J*P001K+
  ##               I[1]*P0*P0*P00J*(1-P00J)*P001J*
  ##               P001K/(P0*pi0J)+I[1]*I[3]*P0*P0*P00J*P00K*P001J*
  ##               (1-P001J)/(P0*pi0J*P00J*pi00J))*u001J*u001K
  ##  A001.010<-( P0*(1-P0)*P00J*P10K*P001J*P010K-
  ##               I[1]*P0*P0*P00J*(1-P00J)*P001J*
  ##               P010K/(P0*pi0J))*u001J*u010K
  ##  A001.011<-( P0*(1-P0)*P00J*P10K*P001J*P011K-
  ##               I[1]*P0*P0*P00J*(1-P00J)*P001J*
  ##               P011K/(P0*pi0J))*u001J*u011K
  ...
  ##  A010.000<-( P0*(1-P0)*P01J*P00K*P010J*P000K-
  ##               I[1]*P0*P0*P01J*(1-P01J)*P010J*
  ##               P000K/(P0*pi0J))*u010J*u000K
  ##  A010.001<-( P0*(1-P0)*P01J*P00K*P010J*P001K-
  ##               I[1]*P0*P0*P01J*(1-P01J)*P010J*
  ##               P001K/(P0*pi0J))*u010J*u001K
  ##  A010.010<-( P0*(1-P0)*P01J*P01K*P010J*P010K+
  ##               I[1]*P0*P0*P01J*(1-P01J)*P010J*
  ##               P010K/(P0*pi0J)+I[1]*I[3]*P0*P0*P01J*
  ##               P01K*P010J*(1-P010J)/(P0*pi0J*P01J*pi01J))*u010J*u010K
  ##  A010.011<-( P0*(1-P0)*P01J*P01K*P010J*P011K+
  ##               I[1]*P0*P0*P01J*(1-P01J)*P010J*
  ##               P011K/(P0*pi0J)-I[1]*I[3]*P0*P0*P01J*
  ##               P01K*P010J*(1-P010J)/(P0*pi0J*P01J*pi01J))*u010J*u011K
  ...
  ##  A011.000<-( P0*(1-P0)*P01J*P00K*P011J*P000K-
  ##               I[1]*P0*P0*P01J*(1-P01J)*P011J*
  ##               P000K/(P0*pi0J))*u011J*u000K
  ##  A011.001<-( P0*(1-P0)*P01J*P00K*P011J*P001K-
  ##               I[1]*P0*P0*P01J*(1-P01J)*P011J*
  ##               P001K/(P0*pi0J))*u011J*u001K
  ##  A011.010<-( P0*(1-P0)*P01J*P01K*P011J*P010K+
  ##               I[1]*P0*P0*P01J*(1-P01J)*P011J*
  ##               P010K/(P0*pi0J)-I[1]*I[3]*P0*P0*P01J*P01K*
  ##               P011J*(1-P011J)/(P0*pi0J*P01J*pi01J))*u011J*u010K
  ##  A011.011<-( P0*(1-P0)*P01J*P01K*P011J*P011K+
  ##               I[1]*P0*P0*P01J*(1-P01J)*P011J*
  ##               P011K/(P0*pi0J)+I[1]*I[3]*P0*P0*P01J*
  ##               P01K*P011J*(1-P011J)/(P0*pi0J*P01J*pi01J))*u011J*u011K
  ...
  ##  A100.100<-( P1*(1-P1)*P10J*P10K*P100J*P100K+
  ##               I[1]*P1*P1*P10J*(1-P10J)*P100J*
  ##               P100K/(P1*pi1J)+I[1]*I[3]*P1*P1*
  ##               P10J*P10K*P100J*(1-P100J)/(P1*pi1J*P10J*pi10J))*
  ##    u100J*u100K
  ##  A100.101<-( P1*(1-P1)*P10J*P10K*P100J*P101K+
  ##               I[1]*P1*P1*P10J*(1-P10J)*P100J*
  ##               P101K/(P1*pi1J)-I[1]*I[3]*P1*P1*
  ##               P10J*P10K*P100J*(1-P100J)/(P1*pi1J*P10J*pi10J))*
  ##    u100J*u101K
  ##  A100.110<-( P1*(1-P1)*P10J*P11K*P100J*P110K-
  ##               I[1]*P1*P1*P10J*(1-P10J)*P100J*
  ##               P110K/(P1*pi1J))*u100J*u110K
  ##  A100.111<-( P1*(1-P1)*P10J*P11K*P100J*P111K-
  ##               I[1]*P1*P1*P10J*(1-P10J)*P100J*
  ##               P111K/(P1*pi1J))*u100J*u111K
  ...
  ##  A101.100<-( P1*(1-P1)*P10J*P10K*P101J*P100K+
  ##               I[1]*P1*P1*P10J*(1-P10J)*P101J*
  ##               P100K/(P1*pi1J)-I[1]*I[3]*P1*P1*
  ##               P10J*P10K*P101J*(1-P101J)/(P1*pi1J*
  ##                                            P10J*pi10J))*u101J*u100K
  ##  A101.101<-( P1*(1-P1)*P10J*P10K*P101J*P101K+
  ##               I[1]*P1*P1*P10J*(1-P10J)*P101J*
  ##               P101K/(P1*pi1J)+I[1]*I[3]*P1*P1*P10J*
  ##               P10K*P101J*(1-P101J)/(P1*pi1J*
  ##                                       P10J*pi10J))*u101J*u101K
  ##  A101.110<-( P1*(1-P1)*P10J*P11K*P101J*P110K+
  ##               I[1]*P1*P1*P10J*(1-P10J)*P101J*
  ##               P110K/(P1*pi1J))*u101J*u110K
  ##  A101.111<-( P1*(1-P1)*P10J*P11K*P101J*P111K+
  ##               I[1]*P1*P1*P10J*(1-P10J)*P101J*
  ##               P111K/(P1*pi1J))*u101J*u111K
##
  ...
  ##  A110.100<-( P1*(1-P1)*P11J*P10K*P110J*P100K-
  ##               I[1]*P1*P1*P11J*(1-P11J)*P110J*
  ##               P100K/(P1*pi1J))*u110J*u100K
  ##  A110.101<-( P1*(1-P1)*P11J*P10K*P110J*P101K-
  ##               I[1]*P1*P1*P11J*(1-P11J)*P110J*
  ##               P101K/(P1*pi1J))*u110J*u101K
  ##  A110.110<-( P1*(1-P1)*P11J*P11K*P110J*P110K+
  ##               I[1]*P1*P1*P11J*(1-P11J)*P110J*
  ##               P110K/(P1*pi1J)-I[1]*I[3]*P1*P1*
  ##               P11J*P11K*P110J*(1-P110J)/(P1*pi1J*P11J*pi11J))*
  ##    u110J*u110K
  ##  A110.111<-( P1*(1-P1)*P11J*P11K*P110J*P111K+
  ##               I[1]*P1*P1*P11J*(1-P11J)*P111J*
  ##               P111K/(P1*pi1J)-I[1]*I[3]*P1*P1*
  ##               P11J*P11K*P110J*(1-P110J)/(P1*pi1J*P11J*pi11J))*u110J*u111K
  ...
  ##  A111.100<-( P1*(1-P1)*P11J*P10K*P111J*P100K-
  ##               I[1]*P1*P1*P11J*(1-P11J)*P111J*
  ##               P100K/(P1*pi1J))*u111J*u100K
  ##  A111.101<-( P1*(1-P1)*P11J*P10K*P111J*P101K-
  ##               I[1]*P1*P1*P11J*(1-P11J)*P111J*
  ##               P101K/(P1*pi1J))*u111J*u101K
  ##  A111.110<-( P1*(1-P1)*P11J*P11K*P111J*P110K+
  ##               I[1]*P1*P1*P11J*(1-P11J)*P111J*
  ##               P110K/(P1*pi1J)-I[1]*I[3]*P1*P1*
  ##               P11J*P11K*P111J*(1-P111J)/(P1*pi1J*P11J*pi11J))*
  ##    u111J*u110K
  ##  A111.111<-( P1*(1-P1)*P11J*P11K*P111J*P111K+
  ##               I[1]*P1*P1*P11J*(1-P11J)*P111J*
  ##               P111K/(P1*pi1J)+I[1]*I[3]*P1*P1*P11J*
  ##               P11K*P111J*(1-P111J)/(P1*pi1J*P11J*pi11J))*u111J*u111K
  ##  A<-sum(A000.000,A000.001,A000.010,A000.011,A000.100,
  ##        A000.101,A000.110,A000.111,
  ##        A001.000,A001.001,A001.010,A001.011,A001.100,
  ##        A001.101,A001.110,A001.111,
  ##        A010.000,A010.001,A010.010,A010.011,A010.100,
  ##        A010.101,A010.110,A010.111,
  ##        A011.000,A011.001,A011.010,A011.011,A011.100,
  ##        A011.101,A011.110,A011.111,
  ##        A100.000,A100.001,A100.010,A100.011,A100.100,
  ##        A100.101,A100.110,A100.111,
  ##        A101.000,A101.001,A101.010,A101.011,A101.100,
  ##        A101.101,A101.110,A101.111,
  ##        A110.000,A110.001,A110.010,A110.011,A110.100,
  ##        A110.101,A110.110,A110.111,
  ##        A111.000,A111.001,A111.010,A111.011,A111.100,
  ##        A111.101,A111.110,A111.111)
##
  ##  if (FA=="binomial"){
  ##    if (I[1]==1 && I[3]==1 && I[ 7]==1) {
  ##      B000.000<-P0*P0*P00J*P00K*P000J*
  ##        P000K*bv000J/(P0*pi0J*P00J*pi00J*P000J*pi000J)}
  ##    else {B000.000<-0}
  ##    if (I[1]==1 && I[3]==1 && I[ 8]==1) {
  ##      B001.001<-P0*P0*P01J*P01K*P001J*
  ##        P001K*bv001J/(P0*pi0J*P00J*pi00J*P001J*pi001J)}
  ##    else {B001.001<-0}
  ##    if (I[1]==1 && I[4]==1 && I[ 9]==1) {
  ##      B010.010<-P0*P0*P01J*P01K*P010J*
  ##        P010K*bv010J/(P0*pi0J*P01J*pi01J*P010J*pi010J)}
  ##    else {B010.010<-0}
  ##    if (I[1]==1 && I[4]==1 && I[10]==1) {
  ##      B011.011<-P0*P0*P01J*P01K*P011J*
  ##        P011K*bv011J/(P0*pi0J*P01J*pi01J*P011J*pi011J)}
  ##    else {B011.011<-0}
  ##    if (I[1]==1 && I[5]==1 && I[11]==1) {
  ##      B100.100<-P1*P1*P10J*P10K*P100J*
  ##        P100K*bv100J/(P1*pi1J*P10J*pi10J*P100J*pi100J)}
  ##    else {B100.100<-0}
  ##    if (I[1]==1 && I[5]==1 && I[12]==1) {
  ##      B101.101<-P1*P1*P10J*P10K*P101J*
  ##        P101K*bv101J/(P1*pi1J*P10J*pi10J*P101J*pi101J)}
  ##    else {B101.101<-0}
  ##    if (I[1]==1 && I[6]==1 && I[13]==1) {
  ##      B110.110<-P1*P1*P11J*P11K*P110J*
  ##        P110K*bv110J/(P1*pi1J*P11J*pi11J*P110J*pi110J)}
  ##    else {B110.110<-0}
  ##    if (I[1]==1 && I[6]==1 && I[14]==1) {
  ##      B111.111<-P1*P1*P11J*P11K*P111J*
  ##        P111K*bv111J/(P1*pi1J*P11J*pi11J*P111J*pi111J)}
  ##    else {B111.111<-0}
  ##    } else
  ##    if(FA=="gaussian"){
  ##    if (I[1]==1 && I[3]==1 && I[ 7]==1) {
  ##      B000.000<-P0*P0*P00J*P00K*P000J*P000K*
  ##        v000J/(P0*pi0J*P00J*pi00J*P000J*pi000J)}
  ##    else {B000.000<-0}
  ##  if (I[1]==1 && I[3]==1 && I[ 8]==1) {
  ##    B001.001<-P0*P0*P01J*P01K*P001J*
  ##      P001K*v001J/(P0*pi0J*P00J*pi00J*P001J*pi001J)}
  ##    else {B001.001<-0}
  ##  if (I[1]==1 && I[4]==1 && I[ 9]==1) {
  ##    B010.010<-P0*P0*P01J*P01K*P010J*
  ##      P010K*v010J/(P0*pi0J*P01J*pi01J*P010J*pi010J)}
  ##    else {B010.010<-0}
  ##  if (I[1]==1 && I[4]==1 && I[10]==1) {
  ##    B011.011<-P0*P0*P01J*P01K*P011J*P011K*
  ##      v011J/(P0*pi0J*P01J*pi01J*P011J*pi011J)}
  ##    else {B011.011<-0}
  ##  if (I[1]==1 && I[5]==1 && I[11]==1) {
  ##    B100.100<-P1*P1*P10J*P10K*P100J*P100K*
  ##      v100J/(P1*pi1J*P10J*pi10J*P100J*pi100J)}
  ##    else {B100.100<-0}
  ##  if (I[1]==1 && I[5]==1 && I[12]==1) {
  ##    B101.101<-P1*P1*P10J*P10K*P101J*P101K*
  ##      v101J/(P1*pi1J*P10J*pi10J*P101J*pi101J)}
  ##    else {B101.101<-0}
  ##  if (I[1]==1 && I[6]==1 && I[13]==1) {
  ##    B110.110<-P1*P1*P11J*P11K*P110J*P110K*
  ##      v110J/(P1*pi1J*P11J*pi11J*P110J*pi110J)}
  ##    else {B110.110<-0}
  ##  if (I[1]==1 && I[6]==1 && I[14]==1) {
  ##    B111.111<-P1*P1*P11J*P11K*P111J*P111K*
  ##      v111J/(P1*pi1J*P11J*pi11J*P111J*pi111J)}
  ##    else {B111.111<-0}
  ##  }else
  ##    stop("invalid enter for argument 'family'")
