...
#' @param d Critical value of distance of the searching procedure. The search of non-centralized parameter value stops at the absolute distance between the actual power and the target power less than the value of d. The default value of d=0.0001
#' @param start Initial value of searching the non-centralized parameter.
#' @param dec A numeric number to specify the decimal of the output parameter value. The default of dec=2.
...
getncp=function(df,alpha=0.05,beta=0.20,d=0.0001,start=5,dec=2){
