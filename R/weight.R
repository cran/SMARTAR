...
##D$A1==i & D$O2==j & D$A2==k)]))
##          for (l in Lvec){
##            Mvec<-sort(unique(D$A3[which(D$O1==h & D$A1==i &
##                                          D$O2==j & D$A2==k & D$O3==l)]))
##            for (m in Mvec) {
##              nn3<-length(D$Y[D$O1==h & D$A1==i & D$O2==j &
##                               D$A2==k & D$O3==l & D$A3==m])
##              nd3<-length(D$Y[D$O1==h & D$A1==i & D$O2==j &
##D$A2==k & D$O3==l])
##              D$P3[which(D$O1==h & D$A1==i & D$O2==j & D$A2==k &
##                           D$O3==l & D$A3==m)]<-nn3/nd3
##              D$IPW<-1/(D$P1*D$P2*D$P3)
##              }}}}}}}
       return(D$IPW)
}
