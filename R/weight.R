...
weight=function(data){
       ...
       if (Nstage==1 & Base==0) {P1=IPW=rep(NA,N); D=data.frame(D,P1,IPW)
       ...
       if (Nstage==1 & Base==1) {P1=IPW=rep(NA,N); D=data.frame(D,P1,IPW)
       ...
       if (Nstage==2 & Base==0) {P1=P2=IPW=rep(NA,N); D=data.frame(D,P1,P2,IPW)
                                 Ivec=sort(unique(D$A1))
                                 for (i in Ivec){
       ...
       if (Nstage==2 & Base==1) {P1=P2=IPW=rep(NA,N); D=data.frame(D,P1,P2,IPW)
       ...
       if (Nstage==3 & Base==0) {P1=P2=P3=IPW=rep(NA,N); D=data.frame(D,P1,P2,P3=IPW)
                                 Ivec=sort(unique(D$A1))
                                 for (i in Ivec){
                                      nn1=length(D$Y[D$A1==i])
                                      nd1=N
       ...
       if (Nstage==3 & Base==1) {P1=P2=P3=IPW=rep(NA,N); D=data.frame(D,P1,P2,P3=IPW)
                                 Hvec=sort(unique(D$O1))
                                 for (h in Hvec){
                                      Ivec=sort(unique(D$A1[which(D$O1==h)]))
                                      for (i in Ivec){
                                           ...
                                           for (j in Jvec){
                                                ...
                                                for (k in Kvec){
                                                     ...
                                                     for (l in Lvec){
                                                          ...
                                                          for (m in Mvec) {
                                                               nn3=length(D$Y[D$O1==h & D$A1==i & D$O2==j & D$A2==k & D$O3==l & D$A3==m])
                                                               nd3=length(D$Y[D$O1==h & D$A1==i & D$O2==j & D$A2==k & D$O3==l])
                                                               D$P3[which(D$O1==h & D$A1==i & D$O2==j & D$A2==k & D$O3==l & D$A3==m)]=nn3/nd3
                                                               D$IPW=1/(D$P1*D$P2*D$P3)
                                                               }}}}}}}
       return(D$IPW)
}
